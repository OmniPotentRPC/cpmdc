...
static const struct CatalogCoverage cpmd_coverage[] = {
    ...
    {"catalog.cpmd.ROKS_EXPERT", "roksExpertPayload", " ROKS TRIPLET EXPERT"},
    ...
    {"catalog.cpmd.FINITE_DIFFERENCES", "finiteDifferences",
     " FINITE DIFFERENCES\n"},
    {"catalog.cpmd.TASKGROUPS", "taskGroups", " TASKGROUPS CARTESIAN\n"},
...
int main(int argc, char **argv) {
  ...
  const char *cpmd_misc_need[] = {
      ...
      "SURFACE HOPPING NEW RESTART SHIFT=0.25", "ROKS TRIPLET EXPERT",
