...
The inventory files are part of the public compatibility contract, not
only generated lookup data. ``schema/inventory/cpmd_cp_keywords.txt``
...
schema, public C feature table, README, and this reference page. When
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.OPTIMIZE_GEOMETRY_CLASSICAL``             | ``params.inputSections.cpmd.optimizeGeometryOptions``             | ``optimizeGeometryOptions``             | ``OPTIMIZE GEOMETRY CLASSICAL``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.OPTIMIZE_GEOMETRY_XYZ``                   | ``params.inputSections.cpmd.optimizeGeometryOptions``             | ``optimizeGeometryOptions``             | ``OPTIMIZE GEOMETRY XYZ``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.OPTIMIZE_GEOMETRY_SAMPLE_OPTION``         | ``params.inputSections.cpmd.optimizeGeometryOptions``             | ``optimizeGeometryOptions``             | ``OPTIMIZE GEOMETRY SAMPLE option``         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.OPTIMIZE_COMBINED_XYZ``                   | ``params.inputSections.cpmd.optimizeCombinedOptions``             | ``optimizeCombinedOptions``             | ``OPTIMIZE COMBINED XYZ``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.OPTIMIZE_COMBINED_SAMPLE_OPTION``         | ``params.inputSections.cpmd.optimizeCombinedOptions``             | ``optimizeCombinedOptions``             | ``OPTIMIZE COMBINED SAMPLE option``         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MOLECULAR_DYNAMICS_FILE_XYZ``             | ``params.inputSections.cpmd.molecularDynamicsFileOptions``        | ``molecularDynamicsFileOptions``        | ``MOLECULAR DYNAMICS FILE XYZ``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MOLECULAR_DYNAMICS_FILE_NSKIP``           | ``params.inputSections.cpmd.molecularDynamicsFileOptions``        | ``molecularDynamicsFileOptions``        | ``MOLECULAR DYNAMICS FILE NSKIP``           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MOLECULAR_DYNAMICS_FILE_NSAMPLE``         | ``params.inputSections.cpmd.molecularDynamicsFileOptions``        | ``molecularDynamicsFileOptions``        | ``MOLECULAR DYNAMICS FILE NSAMPLE``         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PARRINELLO_RAHMAN_NPT``                   | ``params.inputSections.cpmd.parrinelloRahmanOptions``             | ``parrinelloRahmanOptions``             | ``PARRINELLO-RAHMAN NPT``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PARRINELLO_RAHMAN_SHOCK``                 | ``params.inputSections.cpmd.parrinelloRahmanOptions``             | ``parrinelloRahmanOptions``             | ``PARRINELLO-RAHMAN SHOCK``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PARRINELLO_RAHMAN_TOLKINC``               | ``params.inputSections.cpmd.parrinelloRahmanOptions``             | ``parrinelloRahmanOptions``             | ``PARRINELLO-RAHMAN TOLKINC``               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.COMVEL``                                  | ``params.inputSections.cpmd.subtractComVelocity``                 | ``subtractComVelocity``                 | ``COMVEL``                                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ROTVEL``                                  | ``params.inputSections.cpmd.subtractRotVelocity``                 | ``subtractRotVelocity``                 | ``ROTVEL``                                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.NOSE_IONS_ULTRA``                         | ``params.inputSections.cpmd.noseIonsOptions``                     | ``noseIonsOptions``                     | ``NOSE IONS ULTRA``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.NOSE_IONS_MASSIVE``                       | ``params.inputSections.cpmd.noseIonsOptions``                     | ``noseIonsOptions``                     | ``NOSE IONS MASSIVE``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.NOSE_IONS_CENTROIDOFF``                   | ``params.inputSections.cpmd.noseIonsOptions``                     | ``noseIonsOptions``                     | ``NOSE IONS CENTROIDOFF``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.NOSE_IONS_T0``                            | ``params.inputSections.cpmd.noseIonsOptions``                     | ``noseIonsOptions``                     | ``NOSE IONS T0``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRACE_ALL``                               | ``params.inputSections.cpmd.traceOptions``                        | ``traceOptions``                        | ``TRACE ALL``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRACE_MASTER``                            | ``params.inputSections.cpmd.traceOptions``                        | ``traceOptions``                        | ``TRACE MASTER``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MOLECULE_ISOLATED``                       | ``params.inputSections.cpmd.isolatedMolecule``                    | ``isolatedMolecule``                    | ``MOLECULE ISOLATED``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PRINT``                                   | ``params.inputSections.cpmd.printOptions``                        | ``printOptions``                        | ``PRINT``                                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PRINT_FORCES``                            | ``params.inputSections.cpmd.printOptions``                        | ``printOptions``                        | ``PRINT FORCES``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PRINT_ON``                                | ``params.inputSections.cpmd.printOptions``                        | ``printOptions``                        | ``PRINT ON``                                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STRUCTURE``                               | ``params.inputSections.cpmd.structureOptions``                    | ``structureOptions``                    | ``STRUCTURE``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STRUCTURE_BONDS``                         | ``params.inputSections.cpmd.structureOptions``                    | ``structureOptions``                    | ``STRUCTURE BONDS``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STRUCTURE_ANGLES``                        | ``params.inputSections.cpmd.structureOptions``                    | ``structureOptions``                    | ``STRUCTURE ANGLES``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STRUCTURE_DIHEDRALS``                     | ``params.inputSections.cpmd.structureOptions``                    | ``structureOptions``                    | ``STRUCTURE DIHEDRALS``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STRUCTURE_SELECT``                        | ``params.inputSections.cpmd.structureOptions``                    | ``structureOptions``                    | ``STRUCTURE SELECT``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STORE_WAVEFUNCTION``                      | ``params.inputSections.cpmd.storeOptions``                        | ``storeOptions``                        | ``STORE WAVEFUNCTION``                      |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STORE_SELECTION``                         | ``params.inputSections.cpmd.storeSelection``                      | ``storeSelection``                      | ``STORE``                                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STORE_SELECTION_WAVEFUNCTION``            | ``params.inputSections.cpmd.storeSelection``                      | ``storeSelection``                      | ``STORE SELECTION WAVEFUNCTION``            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STORE_SELECTION_DENSITY``                 | ``params.inputSections.cpmd.storeSelection``                      | ``storeSelection``                      | ``STORE SELECTION DENSITY``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STORE_OFF_POTENTIAL``                     | ``params.inputSections.cpmd.storeOffSelection``                   | ``storeOffSelection``                   | ``STORE OFF POTENTIAL``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRAJECTORY_XYZ``                          | ``params.inputSections.cpmd.trajectoryOptions``                   | ``trajectoryOptions``                   | ``TRAJECTORY XYZ``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRAJECTORY_BINARY``                       | ``params.inputSections.cpmd.trajectoryOptions``                   | ``trajectoryOptions``                   | ``TRAJECTORY BINARY``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRAJECTORY_FORCES``                       | ``params.inputSections.cpmd.trajectoryOptions``                   | ``trajectoryOptions``                   | ``TRAJECTORY FORCES``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRAJECTORY_RANGE_OPTION``                 | ``params.inputSections.cpmd.trajectoryOptions``                   | ``trajectoryOptions``                   | ``TRAJECTORY RANGE option``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TRAJECTORY_SAMPLE_OPTION``                | ``params.inputSections.cpmd.trajectoryOptions``                   | ``trajectoryOptions``                   | ``TRAJECTORY SAMPLE option``                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WANNIER_OPTIMIZATION_JACOBI``             | ``params.inputSections.cpmd.wannierOptimization``                 | ``wannierOptimization``                 | ``WANNIER OPTIMIZATION JACOBI``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WANNIER_TYPE_RESTA``                      | ``params.inputSections.cpmd.wannierType``                         | ``wannierType``                         | ``WANNIER TYPE RESTA``                      |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WANNIER_WFNOUT``                          | ``params.inputSections.cpmd.wannierWfnOutOptions``                | ``wannierWfnOutOptions``                | ``WANNIER WFNOUT``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WANNIER_WFNOUT_OPTIONS``                  | ``params.inputSections.cpmd.wannierWfnOutOptions``                | ``wannierWfnOutOptions``                | ``WANNIER WFNOUT``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WANNIER_WFNOUT_PARTIAL``                  | ``params.inputSections.cpmd.wannierWfnOutOptions``                | ``wannierWfnOutOptions``                | ``WANNIER WFNOUT PARTIAL``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WANNIER_WFNOUT_DENSITY``                  | ``params.inputSections.cpmd.wannierWfnOutOptions``                | ``wannierWfnOutOptions``                | ``WANNIER WFNOUT DENSITY``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.COMPRESS_WRITE32``                        | ``params.inputSections.cpmd.compress``                            | ``compress``                            | ``COMPRESS WRITE32``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MEMORY``                                  | ``params.inputSections.cpmd.memory``                              | ``memory``                              | ``MEMORY``                                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MEMORY_CHECK``                            | ``params.inputSections.cpmd.memory``                              | ``memory``                              | ``MEMORY CHECK``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MEMORY_SMALL``                            | ``params.inputSections.cpmd.memory``                              | ``memory``                              | ``MEMORY SMALL``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SPLINE_POINTS_OPTION``                    | ``params.inputSections.cpmd.splineOptions``                       | ``splineOptions``                       | ``SPLINE POINTS option``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SPLINE_QFUNCTION``                        | ``params.inputSections.cpmd.splineOptions``                       | ``splineOptions``                       | ``SPLINE QFUNCTION``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SPLINE_INIT``                             | ``params.inputSections.cpmd.splineOptions``                       | ``splineOptions``                       | ``SPLINE INIT``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SPLINE_RANGE_OPTION``                     | ``params.inputSections.cpmd.splineOptions``                       | ``splineOptions``                       | ``SPLINE RANGE option``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.FINITE_DIFFERENCES_COORD``                | ``params.inputSections.cpmd.finiteDifferences``                   | ``finiteDifferences``                   | ``FINITE DIFFERENCES COORD``                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.FINITE_DIFFERENCES_RADIUS``               | ``params.inputSections.cpmd.finiteDifferences``                   | ``finiteDifferences``                   | ``FINITE DIFFERENCES RADIUS``               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TASKGROUPS_CARTESIAN``                    | ``params.inputSections.cpmd.taskGroups``                          | ``taskGroups``                          | ``TASKGROUPS CARTESIAN``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TASKGROUPS_MINI``                         | ``params.inputSections.cpmd.taskGroups``                          | ``taskGroups``                          | ``TASKGROUPS MINI``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.DISTRIBUTE_FNL``                          | ``params.inputSections.cpmd.distributeFnl``                       | ``distributeFnl``                       | ``DISTRIBUTE FNL``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.DISTRIBUTE_FNL_ON``                       | ``params.inputSections.cpmd.distributeFnl``                       | ``distributeFnl``                       | ``DISTRIBUTE FNL ON``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GLOCALIZATION_PARAMETER``                 | ``params.inputSections.cpmd.glocalizationParameters``             | ``glocalizationParameters``             | ``GLOCALIZATION PARAMETER``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GLOCALIZATION_OPTIMIZATION_SD``           | ``params.inputSections.cpmd.glocalizationOptimization``           | ``glocalizationOptimization``           | ``GLOCALIZATION OPTIMIZATION SD``           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GLOCALIZATION_OPTIMIZATION_INTEGRATION``  | ``params.inputSections.cpmd.glocalizationOptimization``           | ``glocalizationOptimization``           | ``GLOCALIZATION OPTIMIZATION INTEGRATION``  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GFUNCTIONAL_TYPE``                        | ``params.inputSections.cpmd.gfunctionalType``                     | ``gfunctionalType``                     | ``GFUNCTIONAL TYPE``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GFUNCTIONAL_TYPE_ZETANUMBER``             | ``params.inputSections.cpmd.gfunctionalType``                     | ``gfunctionalType``                     | ``GFUNCTIONAL TYPE ZETANUMBER``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PIPPO``                                   | ``params.inputSections.cpmd.gUnitarityOptions``                   | ``gUnitarityOptions``                   | ``PIPPO``                                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PIPPO_LAGRANGE``                          | ``params.inputSections.cpmd.gUnitarityOptions``                   | ``gUnitarityOptions``                   | ``PIPPO LAGRANGE``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PIPPO_ORTHO``                             | ``params.inputSections.cpmd.gUnitarityOptions``                   | ``gUnitarityOptions``                   | ``PIPPO ORTHO``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PIPPO_APPROX``                            | ``params.inputSections.cpmd.gUnitarityOptions``                   | ``gUnitarityOptions``                   | ``PIPPO APPROX``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.G_STEP``                                  | ``params.inputSections.cpmd.gStepTune``                           | ``gStepTune``                           | ``G_STEP``                                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.G_STEP_TUNE``                             | ``params.inputSections.cpmd.gStepTune``                           | ``gStepTune``                           | ``G_STEP TUNE``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GLOC_WFNOUT_REAL``                        | ``params.inputSections.cpmd.glocWfnOutOptions``                   | ``glocWfnOutOptions``                   | ``GLOC WFNOUT REAL``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.GLOC_WFNOUT_PARTIAL``                     | ``params.inputSections.cpmd.glocWfnOutOptions``                   | ``glocWfnOutOptions``                   | ``GLOC WFNOUT PARTIAL``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.DISTRIBUTED_LINALG_ON``                   | ``params.inputSections.cpmd.distributedLinalg``                   | ``distributedLinalg``                   | ``DISTRIBUTED LINALG ON``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LINALG_NEWORTHO``                         | ``params.inputSections.cpmd.linalgNewOrtho``                      | ``linalgNewOrtho``                      | ``LINALG NEWORTHO``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LINALG_NEWORTHO_OFF``                     | ``params.inputSections.cpmd.linalgNewOrtho``                      | ``linalgNewOrtho``                      | ``LINALG NEWORTHO OFF``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.MOLECULE_CENTER``                         | ``params.inputSections.cpmd.centerMoleculeOn``                    | ``centerMoleculeOn``                    | ``MOLECULE CENTER``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_ALL``                                | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT ALL``                                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_NEWTON``                             | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT NEWTON``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_HDA``                                | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT HDA``                                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_PROJECT``                            | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT PROJECT``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_AUTO``                               | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT AUTO``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_NOCCOR``                             | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT NOCCOR``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_RESWF``                              | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT RESWF``                              |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CDFT_PHIOUT``                             | ``params.inputSections.cpmd.cdftOptions``                         | ``cdftOptions``                         | ``CDFT PHIOUT``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.COMBINE_SYSTEMS_REFLECT``                 | ``params.inputSections.cpmd.combineSystemsOptions``               | ``combineSystemsOptions``               | ``COMBINE SYSTEMS REFLECT``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.COMBINE_SYSTEMS_SAB``                     | ``params.inputSections.cpmd.combineSystemsOptions``               | ``combineSystemsOptions``               | ``COMBINE SYSTEMS SAB``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.COMBINE_SYSTEMS_NONORTH``                 | ``params.inputSections.cpmd.combineSystemsOptions``               | ``combineSystemsOptions``               | ``COMBINE SYSTEMS NONORTH``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.KSHAM_MATRIX``                            | ``params.inputSections.cpmd.kshamOptions``                        | ``kshamOptions``                        | ``KSHAM MATRIX``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.KSHAM_ROUT``                              | ``params.inputSections.cpmd.kshamOptions``                        | ``kshamOptions``                        | ``KSHAM ROUT``                              |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.WOUT_SLICE``                              | ``params.inputSections.cpmd.woutOptions``                         | ``woutOptions``                         | ``WOUT SLICE``                              |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.DEBUG_HUBBARD``                           | ``params.inputSections.cpmd.debugOptions``                        | ``debugOptions``                        | ``DEBUG HUBBARD``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.KOHN_SHAM_ENERGIES_NOWAVEFUNCTION``       | ``params.inputSections.cpmd.kohnShamEnergiesOptions``             | ``kohnShamEnergiesOptions``             | ``KOHN-SHAM ENERGIES NOWAVEFUNCTION``       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SURFACE_HOPPING_NEW``                     | ``params.inputSections.cpmd.surfaceHoppingOptions``               | ``surfaceHoppingOptions``               | ``SURFACE HOPPING NEW``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SURFACE_HOPPING_RESTART``                 | ``params.inputSections.cpmd.surfaceHoppingOptions``               | ``surfaceHoppingOptions``               | ``SURFACE HOPPING RESTART``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SURFACE_HOPPING_SHIFT``                   | ``params.inputSections.cpmd.surfaceHoppingOptions``               | ``surfaceHoppingOptions``               | ``SURFACE HOPPING SHIFT=``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ROKS``                                    | ``params.inputSections.cpmd.roksOptions``                         | ``roksOptions``                         | ``ROKS``                                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ROKS_LOCALIZED``                          | ``params.inputSections.cpmd.roksOptions``                         | ``roksOptions``                         | ``ROKS LOCALIZED``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ROKS_TRIPLET``                            | ``params.inputSections.cpmd.roksOptions``                         | ``roksOptions``                         | ``ROKS TRIPLET``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ROKS_EXPERT``                             | ``params.inputSections.cpmd.roksExpertPayload``                   | ``roksExpertPayload``                   | ``ROKS EXPERT``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.FIXRHO_UPWFN_PCG``                        | ``params.inputSections.cpmd.fixrhoUpwfnOptions``                  | ``fixrhoUpwfnOptions``                  | ``FIXRHO UPWFN PCG``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BOGOLIUBOV_CORRECTION_OFF``               | ``params.inputSections.cpmd.bogoliubovCorrection``                | ``bogoliubovCorrection``                | ``BOGOLIUBOV CORRECTION OFF``               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VIBRATIONAL_ANALYSIS_LR``                 | ``params.inputSections.cpmd.vibrationalAnalysisOptions``          | ``vibrationalAnalysisOptions``          | ``VIBRATIONAL ANALYSIS LR``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VIBRATIONAL_ANALYSIS_IN``                 | ``params.inputSections.cpmd.vibrationalAnalysisOptions``          | ``vibrationalAnalysisOptions``          | ``VIBRATIONAL ANALYSIS IN``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VIBRATIONAL_ANALYSIS_ACLIMAX``            | ``params.inputSections.cpmd.vibrationalAnalysisOptions``          | ``vibrationalAnalysisOptions``          | ``VIBRATIONAL ANALYSIS ACLIMAX``            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VIBRATIONAL_ANALYSIS_GAUSS``              | ``params.inputSections.cpmd.vibrationalAnalysisOptions``          | ``vibrationalAnalysisOptions``          | ``VIBRATIONAL ANALYSIS GAUSS``              |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ORBITAL_HARDNESS_LR``                     | ``params.inputSections.cpmd.orbitalHardnessOptions``              | ``orbitalHardnessOptions``              | ``ORBITAL HARDNESS LR``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANGEVIN_CPMD``                           | ``params.inputSections.cpmd.langevinOptions``                     | ``langevinOptions``                     | ``LANGEVIN CPMD``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANGEVIN_OPTIMAL``                        | ``params.inputSections.cpmd.langevinOptions``                     | ``langevinOptions``                     | ``LANGEVIN OPTIMAL``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANGEVIN_SMART``                          | ``params.inputSections.cpmd.langevinOptions``                     | ``langevinOptions``                     | ``LANGEVIN SMART``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANGEVIN_CUSTOM``                         | ``params.inputSections.cpmd.langevinOptions``                     | ``langevinOptions``                     | ``LANGEVIN CUSTOM``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANGEVIN_MOVECM``                         | ``params.inputSections.cpmd.langevinOptions``                     | ``langevinOptions``                     | ``LANGEVIN MOVECM``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANGEVIN_CENTROIDOFF``                    | ``params.inputSections.cpmd.langevinOptions``                     | ``langevinOptions``                     | ``LANGEVIN CENTROIDOFF``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTERFACE_GMX``                           | ``params.inputSections.cpmd.interfaceOptions``                    | ``interfaceOptions``                    | ``INTERFACE GMX``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTERFACE_IPHIGENIE``                     | ``params.inputSections.cpmd.interfaceOptions``                    | ``interfaceOptions``                    | ``INTERFACE IPHIGENIE``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTERFACE_ESP``                           | ``params.inputSections.cpmd.interfaceOptions``                    | ``interfaceOptions``                    | ``INTERFACE ESP``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTERFACE_PCGFIRST``                      | ``params.inputSections.cpmd.interfaceOptions``                    | ``interfaceOptions``                    | ``INTERFACE PCGFIRST``                      |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.HARMONIC_REFERENCE_OFF``                  | ``params.inputSections.cpmd.harmonicReference``                   | ``harmonicReference``                   | ``HARMONIC REFERENCE OFF``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SCALED_MASSES``                           | ``params.inputSections.cpmd.scaledMasses``                        | ``scaledMasses``                        | ``SCALED MASSES``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.SCALED_MASSES_OFF``                       | ``params.inputSections.cpmd.scaledMasses``                        | ``scaledMasses``                        | ``SCALED MASSES OFF``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.NONORTHOGONAL_ORBITALS_ON``               | ``params.inputSections.cpmd.nonorthogonalOrbitalsOptions``        | ``nonorthogonalOrbitalsOptions``        | ``NONORTHOGONAL ORBITALS ON``               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANCZOS_ALL``                             | ``params.inputSections.cpmd.lanczosDiagonalizationOptions``       | ``lanczosDiagonalizationOptions``       | ``LANCZOS ALL``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANCZOS_NEW``                             | ``params.inputSections.cpmd.lanczosDiagonalizationOptions``       | ``lanczosDiagonalizationOptions``       | ``LANCZOS NEW``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANCZOS_PERIODIC``                        | ``params.inputSections.cpmd.lanczosDiagonalizationOptions``       | ``lanczosDiagonalizationOptions``       | ``LANCZOS PERIODIC``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LANCZOS_RESET``                           | ``params.inputSections.cpmd.lanczosDiagonalizationOptions``       | ``lanczosDiagonalizationOptions``       | ``LANCZOS RESET``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ANDERSON_MIXING_GSPACE``                  | ``params.inputSections.cpmd.andersonMixingGspace``                | ``andersonMixingGspace``                | ``ANDERSON MIXING G-SPACE``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_ADAPT``                    | ``params.inputSections.cpmd.broydenMixingOptions``                | ``broydenMixingOptions``                | ``BROYDEN MIXING ADAPT``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_MIX``                      | ``params.inputSections.cpmd.broydenMixingPayload``                | ``broydenMixingPayload``                | ``BROYDEN MIXING MIX``                      |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_CUTBROY``                  | ``params.inputSections.cpmd.broydenMixingPayload``                | ``broydenMixingPayload``                | ``BROYDEN MIXING CUTBROY``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_W02``                      | ``params.inputSections.cpmd.broydenMixingPayload``                | ``broydenMixingPayload``                | ``BROYDEN MIXING W02``                      |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_NFRBROY``                  | ``params.inputSections.cpmd.broydenMixingPayload``                | ``broydenMixingPayload``                | ``BROYDEN MIXING NFRBROY``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_RESET``                    | ``params.inputSections.cpmd.broydenMixingPayload``                | ``broydenMixingPayload``                | ``BROYDEN MIXING RESET``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.BROYDEN_MIXING_KERMIX``                   | ``params.inputSections.cpmd.broydenMixingPayload``                | ``broydenMixingPayload``                | ``BROYDEN MIXING KERMIX``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.EXTRAPOLATE_WFN_STORE``                   | ``params.inputSections.cpmd.extrapolateWfnOptions``               | ``extrapolateWfnOptions``               | ``EXTRAPOLATE WFN STORE``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.EXTRAPOLATE_WFN_ASPC``                    | ``params.inputSections.cpmd.extrapolateWfnOptions``               | ``extrapolateWfnOptions``               | ``EXTRAPOLATE WFN ASPC``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.EXTRAPOLATE_WFN_CSTEPS``                  | ``params.inputSections.cpmd.extrapolateWfnOptions``               | ``extrapolateWfnOptions``               | ``EXTRAPOLATE WFN CSTEPS``                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TSDE_NOPREC``                             | ``params.inputSections.cpmd.tsdeOptions``                         | ``tsdeOptions``                         | ``TSDE NOPREC``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TSDP``                                    | ``params.inputSections.cpmd.tsdpOptions``                         | ``tsdpOptions``                         | ``TSDP``                                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.TSDP_LINE``                               | ``params.inputSections.cpmd.tsdpOptions``                         | ``tsdpOptions``                         | ``TSDP LINE``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STEEPEST_DESCENT_ELECTRONS``              | ``params.inputSections.cpmd.steepestDescentOptions``              | ``steepestDescentOptions``              | ``STEEPEST DESCENT ELECTRONS``              |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STEEPEST_DESCENT_NOPREC``                 | ``params.inputSections.cpmd.steepestDescentOptions``              | ``steepestDescentOptions``              | ``STEEPEST DESCENT NOPREC``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STEEPEST_DESCENT_IONS``                   | ``params.inputSections.cpmd.steepestDescentOptions``              | ``steepestDescentOptions``              | ``STEEPEST DESCENT IONS``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STEEPEST_DESCENT_LINE``                   | ``params.inputSections.cpmd.steepestDescentOptions``              | ``steepestDescentOptions``              | ``STEEPEST DESCENT LINE``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.STEEPEST_DESCENT_CELL``                   | ``params.inputSections.cpmd.steepestDescentOptions``              | ``steepestDescentOptions``              | ``STEEPEST DESCENT CELL``                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CONJUGATE_GRADIENT_ELECTRONS``            | ``params.inputSections.cpmd.conjugateGradientOptions``            | ``conjugateGradientOptions``            | ``CONJUGATE GRADIENT ELECTRONS``            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CONJUGATE_GRADIENT_NOPREC``               | ``params.inputSections.cpmd.conjugateGradientOptions``            | ``conjugateGradientOptions``            | ``CONJUGATE GRADIENT NOPREC``               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CONJUGATE_GRADIENT_MINIMIZE``             | ``params.inputSections.cpmd.conjugateGradientOptions``            | ``conjugateGradientOptions``            | ``CONJUGATE GRADIENT MINIMIZE``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.CONJUGATE_GRADIENT_IONS``                 | ``params.inputSections.cpmd.conjugateGradientOptions``            | ``conjugateGradientOptions``            | ``CONJUGATE GRADIENT IONS``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ODIIS_OPTIONS``                           | ``params.inputSections.cpmd.odiisOptions``                        | ``odiisOptions``                        | ``ODIIS``                                   |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ODIIS_NOPREC``                            | ``params.inputSections.cpmd.odiisOptions``                        | ``odiisOptions``                        | ``ODIIS NOPREC``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ODIIS_NO_RESET``                          | ``params.inputSections.cpmd.odiisOptions``                        | ``odiisOptions``                        | ``ODIIS NO_RESET``                          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.LBFGS_NREM``                              | ``params.inputSections.cpmd.lbfgsOptions``                        | ``lbfgsOptions``                        | ``LBFGS NREM``                              |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.PRFO_NVAR``                               | ``params.inputSections.cpmd.prfoOptions``                         | ``prfoOptions``                         | ``PRFO NVAR``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.IMPLICIT_NEWTON_CONTINUE``                | ``params.inputSections.cpmd.implicitNewtonOptions``               | ``implicitNewtonOptions``               | ``IMPLICIT NEWTON CONTINUE``                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.IMPLICIT_NEWTON_PRECONDITIONED``          | ``params.inputSections.cpmd.implicitNewtonOptions``               | ``implicitNewtonOptions``               | ``IMPLICIT NEWTON PRECONDITIONED``          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.IMPLICIT_NEWTON_ALTERNATIVE``             | ``params.inputSections.cpmd.implicitNewtonOptions``               | ``implicitNewtonOptions``               | ``IMPLICIT NEWTON ALTERNATIVE``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.IMPLICIT_NEWTON_STEP``                    | ``params.inputSections.cpmd.implicitNewtonOptions``               | ``implicitNewtonOptions``               | ``IMPLICIT NEWTON STEP``                    |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.IMPLICIT_NEWTON_VERBOSE``                 | ``params.inputSections.cpmd.implicitNewtonOptions``               | ``implicitNewtonOptions``               | ``IMPLICIT NEWTON VERBOSE``                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.RESTART_COORDINATES``                     | ``params.inputSections.cpmd.restartOptions``                      | ``restartOptions``                      | ``RESTART COORDINATES``                     |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.RESTART_WAVEFUNCTION_OPTION``             | ``params.inputSections.cpmd.restartOptions``                      | ``restartOptions``                      | ``RESTART WAVEFUNCTION option``             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.RESTART_ALL``                             | ``params.inputSections.cpmd.restartOptions``                      | ``restartOptions``                      | ``RESTART ALL``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTFILE``                                 | ``params.inputSections.cpmd.intFileOptions``                      | ``intFileOptions``                      | ``INTFILE``                                 |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTFILE_READ``                            | ``params.inputSections.cpmd.intFileOptions``                      | ``intFileOptions``                      | ``INTFILE READ``                            |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTFILE_WRITE``                           | ``params.inputSections.cpmd.intFileOptions``                      | ``intFileOptions``                      | ``INTFILE WRITE``                           |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INTFILE_FILENAME``                        | ``params.inputSections.cpmd.intFileOptions``                      | ``intFileOptions``                      | ``INTFILE FILENAME``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INITIALIZE_WAVEFUNCTION_ATOMIC``          | ``params.inputSections.cpmd.initializeWavefunctionOptions``       | ``initializeWavefunctionOptions``       | ``INITIALIZE WAVEFUNCTION ATOMIC``          |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.INITIALIZE_WAVEFUNCTION_PRIMITIVE``       | ``params.inputSections.cpmd.initializeWavefunctionOptions``       | ``initializeWavefunctionOptions``       | ``INITIALIZE WAVEFUNCTION PRIMITIVE``       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ORTHOGONALIZATION_LOWDIN``                | ``params.inputSections.cpmd.orthogonalizationOptions``            | ``orthogonalizationOptions``            | ``ORTHOGONALIZATION LOWDIN``                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.ORTHOGONALIZATION_MATRIX``                | ``params.inputSections.cpmd.orthogonalizationOptions``            | ``orthogonalizationOptions``            | ``ORTHOGONALIZATION MATRIX``                |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.QUENCH_OPTIONS``                          | ``params.inputSections.cpmd.quenchOptions``                       | ``quenchOptions``                       | ``QUENCH``                                  |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.QUENCH_IONS``                             | ``params.inputSections.cpmd.quenchOptions``                       | ``quenchOptions``                       | ``QUENCH IONS``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.QUENCH_ELECTRONS``                        | ``params.inputSections.cpmd.quenchOptions``                       | ``quenchOptions``                       | ``QUENCH ELECTRONS``                        |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.QUENCH_BO``                               | ``params.inputSections.cpmd.quenchOptions``                       | ``quenchOptions``                       | ``QUENCH BO``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.QUENCH_CELL``                             | ``params.inputSections.cpmd.quenchOptions``                       | ``quenchOptions``                       | ``QUENCH CELL``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.RANDOMIZE``                               | ``params.inputSections.cpmd.randomizeOptions``                    | ``randomizeOptions``                    | ``RANDOMIZE``                               |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.RANDOMIZE_DENSITY``                       | ``params.inputSections.cpmd.randomizeOptions``                    | ``randomizeOptions``                    | ``RANDOMIZE DENSITY``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
...
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VDW_CORRECTION_ON``                       | ``params.inputSections.cpmd.vdwCorrection``                       | ``vdwCorrection``                       | ``VDW CORRECTION ON``                       |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VDW_WANNIER``                             | ``params.inputSections.cpmd.vdwWannier``                          | ``vdwWannier``                          | ``VDW WANNIER``                             |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
| ``catalog.cpmd.VDW_WANNIER_OFF``                         | ``params.inputSections.cpmd.vdwWannier``                          | ``vdwWannier``                          | ``VDW WANNIER OFF``                         |
+----------------------------------------------------------+-------------------------------------------------------------------+-----------------------------------------+---------------------------------------------+
